Webruntime.define('lwc/jb_resume', ['lwc', 'lightning/configProvider', 'wire-service', 'instrumentation/service', 'aura-storage', 'aura'], function (lwc, configProvider, wireService, service, auraStorage, aura) { 'use strict';
  ...
  function stylesheet(hostSelector, shadowSelector, nativeShadow) {
    return ".scrollArea" + shadowSelector + " {position: fixed;top: 0;left: 0;right: 0;bottom: 0;overflow: auto;}\n.navbar" + shadowSelector + " {overflow: hidden;background-color: #f1f1f1;padding: 77px 10px;transition: 0.4s;position: fixed;top: 0;z-index: 99;background-position: center;top: 3px;border-radius: 10px;width: 100%;}\n.navbar" + shadowSelector + " a" + shadowSelector + " {float: left;color: black;text-align: center;padding: 12px;text-decoration: none;font-size: 18px;line-height: 25px;border-radius: 4px;right: 0px;}\n.navbar" + shadowSelector + " .logo" + shadowSelector + " {font-size: 35px;font-weight: bold;transition: 0.4s;padding: \"25px\";-webkit-animation:colorchange 20s infinite alternate;}\n.navbar" + shadowSelector + " a:hover" + shadowSelector + " {background-color: .ddd;color: black;}\n.navbar" + shadowSelector + " a.active" + shadowSelector + " {background-color: dodgerblue;color: white;}\n.navbar-right" + shadowSelector + " {float: right;background: #f1f1f1;padding: 4px;margin-right: 15px;border-radius: 3px;}\n.SocialBar" + shadowSelector + "{background-repeat: unset;height: 56px;border-radius: 5px;position: fixed;left: 55%;}\n.SocialBarExpand" + shadowSelector + "{border-radius: 5px;position: fixed;left: 96%;bottom: 6px;}\n@media screen and (max-width: 580px) {.navbar" + shadowSelector + " {padding: 20px 10px !important;}\n.navbar" + shadowSelector + " a" + shadowSelector + " {float: none;display: block;text-align: left;}\n.navbar-right" + shadowSelector + " {float: none;}\n}@keyframes colorchange {0% {color: blue;}\n10% {color: #8e44ad;}\n20% {color: #1abc9c;}\n30% {color: #d35400;}\n40% {color: blue;}\n50% {color: #34495e;}\n60% {color: blue;}\n70% {color: #2980b9;}\n80% {color: #f1c40f;}\n90% {color: #2980b9;}\n100% {color: pink;}\n}.scroll-container" + shadowSelector + " {height: 100vh;overflow-y: scroll;scroll-snap-type: y mandatory;}\nsection" + shadowSelector + " {min-height: 100vh;scroll-snap-align: start;}\nsection" + shadowSelector + " {align-items: center;justify-content: center;padding-top: 1px;}\nsection:nth-child(2n)" + shadowSelector + " {background-color: turquoise;}\nsection:nth-child(3n)" + shadowSelector + " {background-color: tomato;}\n.timeline" + shadowSelector + " {position: relative;max-width: 1200px;margin: 0 auto;}\n.timeline" + shadowSelector + "::after {content: '';position: absolute;width: 6px;background-color: white;top: 0;bottom: 0;left: 50%;margin-left: -3px;}\n.container" + shadowSelector + " {padding: 10px 40px;position: relative;background-color: inherit;width: 50%;}\n.container" + shadowSelector + "::after {content: '';position: absolute;width: 25px;height: 25px;right: -17px;background-color: white;border: 4px solid #FF9F55;top: 15px;border-radius: 50%;z-index: 1;}\n.left" + shadowSelector + " {left: 0;}\n.right" + shadowSelector + " {left: 50%;}\n.left" + shadowSelector + "::before {content: \" \";height: 0;position: absolute;top: 22px;width: 0;z-index: 1;right: 30px;border: medium solid white;border-width: 10px 0 10px 10px;border-color: transparent transparent transparent white;}\n.right" + shadowSelector + "::before {content: \" \";height: 0;position: absolute;top: 22px;width: 0;z-index: 1;left: 30px;border: medium solid white;border-width: 10px 10px 10px 0;border-color: transparent white transparent transparent;}\n.right" + shadowSelector + "::after {left: -16px;}\n.content" + shadowSelector + " {padding: 20px 30px;background-color: white;position: relative;border-radius: 6px;}\n@media screen and (max-width: 600px) {.timeline" + shadowSelector + "::after {left: 31px;}\n.container" + shadowSelector + " {width: 100%;padding-left: 70px;padding-right: 25px;}\n.container" + shadowSelector + "::before {left: 60px;border: medium solid white;border-width: 10px 10px 10px 0;border-color: transparent white transparent transparent;}\n.left" + shadowSelector + "::after, .right" + shadowSelector + "::after {left: 15px;}\n.right" + shadowSelector + " {left: 0%;}\n}";
  }
  ...
  **/
  ...
  function tmpl$6($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      attrs: {
        "href": api_scoped_frag_id("#default"),
        "data-id": "logo"
      },
      key: 0
    }, [api_text("\u3010\uFF32\uFF33\uFF2E\u3011")]), api_element("div", {
      classMap: {
        "navbar-right": true
      },
      attrs: {
        "data-id": "navbar-right"
      },
      key: 5
    }, [api_element("a", {
      classMap: {
      ...
      attrs: {
        "data-nav": "menu",
        "href": api_scoped_frag_id("#home"),
        "data-id": "home"
      },
      key: 1,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.navigateHere))
      }
    }, [api_text("Intro")]), api_element("a", {
      attrs: {
        "data-nav": "menu",
      ...
      key: 2,
      on: {
        "click": _m1 || ($ctx._m1 = api_bind($cmp.navigateHere))
      }
    }, [api_text("Work")]), api_element("a", {
      attrs: {
        "data-nav": "menu",
        "href": api_scoped_frag_id("#education"),
        "data-id": "education"
      },
      key: 3,
      on: {
        "click": _m2 || ($ctx._m2 = api_bind($cmp.navigateHere))
      }
    }, [api_text("Education")]), api_element("a", {
      attrs: {
        "data-nav": "menu",
        "href": api_scoped_frag_id("#achivements"),
        "data-id": "achivements"
      },
      key: 4,
      on: {
        "click": _m3 || ($ctx._m3 = api_bind($cmp.navigateHere))
      }
    }, [api_text("Achivements")])])]), api_element("main", {
      classMap: {
        "scroll-container": true
      },
      key: 65,
      on: {
        "scroll": _m5 || ($ctx._m5 = api_bind($cmp.onScroll)),
        "click": _m6 || ($ctx._m6 = api_bind($cmp.show))
      }
    }, [api_element("section", {
      attrs: {
        "data-id": "section",
      ...
      key: 9
    }, [api_text("Rajendra Singh Nagar")])]), api_element("div", {
      classMap: {
      ...
      classMap: {
        ...
        "slds-truncate": true,
        "slds-p-left--x-small": true
      },
      key: 11
    }, [api_text("Rajendra Singh Nagar")])])])]), api_element("p", {
      classMap: {
      ...
      key: 15
    }, [api_text("Techincal Architect \u2601, Syngenta")]), api_element("p", {
      classMap: {
        "slds-p-around_x-small": true
      },
      styleMap: {
      ...
      key: 16
    }, [api_text("\uD83D\uDCE7: Rajendra.mitu06@gmail.com")]), api_element("p", {
      classMap: {
        "slds-p-around_x-small": true
      },
      styleMap: {
      ...
      key: 17
    }, [api_text("Hi there, My Name is Rajendra Singh Nagar. I am a Salesforce Professional working in the role of Technical Architect with Syngenta. With total & relevant experience of 10 years in Salesforce Platform, Product & Technologies, I have long working relationship with Salesforce Consulting companies like Accenture, Cognizant, Infosys. Currently, I am working with Product based company Syngenta where my responsibilities has evloved from a Sr. Developer to Technical Architect.")])])])])])])]), api_element("div", {
      classMap: {
        "SocialBar": true,
        "slds-p-right_x-large": true
      },
      styleMap: {
        "visibility": "hidden",
      ...
      key: 29
    }, [$cmp.socials ? api_custom_element("lightning-layout", _lightningLayout, {
      props: {
        "horizontalAlign": "end"
      },
      key: 28
    }, api_iterator($cmp.socials, function (social) {
      return api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "padding": "around-small"
        },
        key: api_key(27, social.Id)
      }, [api_element("a", {
        attrs: {
          "href": api_scoped_frag_id(social.link),
          "target": "_blank"
        },
        key: 26
      }, [api_element("img", {
        classMap: {
          "slds-p-right--x-small": true
        },
        styleMap: {
          "borderRadius": "7px"
        },
        ...
        classMap: {
          "slds-color__text_gray-2": true
        },
        key: api_key(25, social.Id)
      }, [api_dynamic(social.accountType)])])]);
    })) : null]), api_element("div", {
      classMap: {
        "SocialBarExpand": true
      },
      styleMap: {
        "visibility": "hidden",
        "transition": "visibility 0s, opacity 0.5s linear"
      ...
      key: 30,
      on: {
        "click": _m4 || ($ctx._m4 = api_bind($cmp.expandSocial))
      }
    }, [])])]), api_element("section", {
      styleMap: {
        "paddingTop": "100px"
      ...
      key: 33
    }, [api_text("Job Experiences (Total & Relevant): 10 Years")]), api_element("div", {
      styleMap: {
        "paddingLeft": "15px"
      },
      key: 59
      ...
      key: 34
    }, [api_text("2017")]), api_element("p", {
      key: 35
    }, [api_text("Lorem ipsum dolor sit amet, quo ei simul congue exerci, ad nec admodum perfecto mnesarchum, vim ea mazim fierent detracto. Ea quis iuvaret expetendis his, te elit voluptua dignissim per, habeo iusto primis ea eam.")])])]), api_element("div", {
      classMap: {
        "container": true,
        "right": true
      },
      ...
      key: 54
    }, [api_text("2007")]), api_element("p", {
      key: 55
    }, [api_text("Lorem ipsum dolor sit amet, quo ei simul congue exerci, ad nec admodum perfecto mnesarchum, vim ea mazim fierent detracto. Ea quis iuvaret expetendis his, te elit voluptua dignissim per, habeo iusto primis ea eam.")])])])])])]), api_element("section", {
      styleMap: {
        "paddingTop": "100px"
      },
      attrs: {
        "data-id": "section",
        "id": api_scoped_id("education")
      },
      key: 62
    }, [api_element("h2", {
      key: 61
    }, [api_text("Section 3")])]), api_element("section", {
      styleMap: {
        "paddingTop": "100px"
      },
      attrs: {
        "data-id": "section",
        "id": api_scoped_id("achivements")
      },
      key: 64
    }, [api_element("h2", {
      key: 63
  ...
  tmpl$6.stylesheetTokens = {
    hostAttribute: "lwc-jb_resume_jb_resume-host",
    shadowAttribute: "lwc-jb_resume_jb_resume"
  };

  var ResumeAssets = '/assets/project/4dad36c7b7/staticresources/ResumeAssets';
  ...
  const apexInvoker = getApexInvoker$1("", "Jb_ResumesService", "getResume", false);
  ...
  class Jb_resume extends lwc.LightningElement {
    constructor(...args) {
      super(...args);
      this.socials = [];
    }
    ...
    navigateHere(event) {
      ...
      let targetId = event.currentTarget.dataset.id; // Collapse the header

      this.collapse(); // Update active menu
    ...
    expand() {
      ...
      this.template.querySelector('[data-id="navbar"]').style.fontSize = "30px"; // update content positioning
  ...
  lwc.registerDecorators(Jb_resume, {
    wire: {
      getResumeDetails: {
        adapter: apexInvoker,
        params: {},
        static: {
          resumeId: 'a030o00001ZgITvAAN'
        },
        method: 1
      }
    },
  ...
  var jb_resume = lwc.registerComponent(Jb_resume, {
    tmpl: _tmpl$7
  });
